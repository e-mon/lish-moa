...
def _check_directory(directory: str, if_exists: str) -> str:
    if os.path.exists(directory):
        if if_exists == 'error':
            ...
            warnings.warn('directory {} already exists. It will be replaced by the new result'.format(directory))
...
class Experiment(object):
    ...
    """
    def __init__(self, logging_directory: str, custom_logger: Optional[Logger] = None, with_mlflow: bool = False, if_exists: str = 'error'):
    ...
    def start(self):
        ...
        if self.with_mlflow:
            ...
            mlflow_metadata = {'artifact_uri': active_run.info.artifact_uri, 'experiment_id': active_run.info.experiment_id, 'run_id': active_run.info.run_id}
